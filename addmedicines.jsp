...
<script type="text/javascript" src="js/cuf_run.js"></script>
    ...
    <script>alert('Medicine Added  Success');</script>
    <%}
...
<%@ page session="true" %>    
    ...
    %>
           ...
           <h2>Add Medicines Form</h2>
              <form action="addmedicinesact.jsp" method="post" ><center>
    ...
    <%}%>
                        ...
                        <tr>
                          <td height="43">Medicine</td>
                          <td>
                          <input type="text" id="Site" name="medicine" autocomplete="off" class="text" placeholder="Medicine" /></td>
                        </tr>
                        
                        
                        <tr>
                          <td height="65">Medicine Description</td>
                          <td>
                              <textarea id="address" name="mdd" autocomplete="off" rows="2" cols="15" placeholder="Address"> 
                              </textarea></td>
                        </tr>
                     
                     <tr>
                          <td height="65">Medicine Image</td>
                          <td>
