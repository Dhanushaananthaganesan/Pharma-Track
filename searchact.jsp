		...
		String sp = request.getParameter("sp");	
			...
			Connection connection = Dbconnection.getConnection();
                        ...
                        while(r.next()){
                         ...
                         String q="select * from doctors where hospital = '"+r.getString("hospital")+"' and special = '"+sp+"'  "; 
...
<table>
             <% 
                 ...
                 String price=rs.getString("mobile");
                 String exp=rs.getString("experence");
            ...
            <tr width="100%">
               ...
               <td> <b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Hospital Name : </font>&nbsp;</b>
                ...
                <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Doctor Name : </font>&nbsp;</b> <b><%=rs.getString("doctor")%></b><br>    

                <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Contact : </font>&nbsp;</b> <b><%=price%></b><br>
                
                 <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Experience :</font> &nbsp;</b><b><%=exp%></b>
                </td>
                         </td>
            </tr>
                     </tr>
