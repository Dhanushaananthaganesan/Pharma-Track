    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            ...
            <form action="searchmedact.jsp" method="post" id="leadact" >

              <h2 style="color:black;">Search Doctor </h2>
                 
            <table>
 
            <td><strong><font size="3" color="green">Medicine :</font></strong>
                 <input type="text" name="med"  required=""  autocomplete="off" placeholder= "Medicine" style="height:30px; width:200px"></input>
            </td>
