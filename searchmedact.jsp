    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            ...
            <center>
            <h2 style="color:black;">View Available Medicines</h2>
		...
		String med = request.getParameter("med");	
			...
			Connection connection = Dbconnection.getConnection();
                        ...
                        while(r.next()){
                         ...
                         String q="select * from medicines where hospital = '"+r.getString("hospital")+"'  and medicine = '"+med+"'"; 
...
<table>
            ...
            <tr width="100%">
                ...
                <b><%=rs.getString("hospital")%></b><br>  
                    ...
                    <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Medicine Name : </font>&nbsp;</b> <b><%=rs.getString("medicine")%></b><br>    

                        <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="3"> Uses  :</font>&nbsp;</b> <b><%=exp%></b><br>
